...
class PortalController extends Controller
{
    ...
    {
        $tumbuhan = Ramuan::where('ing_category',1)->where('is_delete',0)->where('is_lulus',1)->get();
        $haiwan = Ramuan::where('ing_category',2)->where('is_delete',0)->where('is_lulus',1)->get();
        $kimia = Ramuan::where('ing_category',3)->where('is_delete',0)->where('is_lulus',1)->get();
