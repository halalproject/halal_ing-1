...
<div class="col-md-12">
    <section class="panel panel-featured panel-featured-info">
        <header class="panel-heading" style="background: -webkit-linear-gradient(top, #00eaff 20%,#ffffff 100%);">
            <h2 class="panel-title"><font color="#000000" size="3"><b>Profil Syarikat</b></font></h2>
        </header>
        <div class="panel-body ">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    <div class="row">
                        <h2 class="panel-title"><font color="#000000" size="3"><b>Pegawai Yang Dilantik</b></font></h2>
                    </div>
                </div>
