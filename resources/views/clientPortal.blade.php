    ...
    <body id="page-top">
        ...
        <section class="page-section bg-light" id="login">
            ...
            <div class="form-group row">
                <label for="colFormLabel" class="col-sm-2 col-form-label">Semak Status Halal :</label>
                <div class="input-group mb-2">
                    <input type="text" class="form-control col-6" id="inlineFormInputGroup" placeholder="Username">
